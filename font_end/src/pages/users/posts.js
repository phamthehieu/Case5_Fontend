...
import {deletePosts, getPostUser} from "../../service/postService";
...
export default function Posts(prop) {
    ...
    const handleDelete = async (idPost) => {
        dispatch(deletePosts(idPost)).then(() => (
            dispatch(profileUser(prop.id)).then(() => {
                    ...
                    <div className="col-6" style={{
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="row">
                                    <div className="col-1">
                                        <img src={prop.user !== undefined && prop.user.image} alt=""
                                             style={{
                                                 width: '50px',
                                                 height: '50px',
                                                 borderRadius: '100%',
                                        ...
                                        <div className="row">
                                            <div className="col-10">
                                                <div className="row">
                                                    <div className="col-12"
                                                         style={{fontSize: '20px'}}>
                                                        <b>{prop.user !== undefined && prop.user.fullName}</b>
                                                    </div>
                                                    <div className="col-12"
                                                         style={{fontSize: '12px'}}>
                                                        <b>{item.time}</b>
                                            ...
                                            <div className="col-2">
                                                <div className="row">
                                                    <div className="col-9" style={{textAlign: 'right'}}>
                                                        <Link type="submit" title="Xóa bài viết "
                                                    ...
                                                    <div className="col-3">
                                                        <Link to={'/edit-post/' + item.idPost} title="Edit post"
